        ...
        return(
            ...
            <div className="signup">
                ...
                <form onSubmit={this.onSubmit}> 
                    ...
                    <div>
                        <TextField name="password" id="password-tb" onChange={this.onChange} value={this.password} type="text" label="Password" />
                    </div>
                    <div>
                        <TextField name="password_c" id="password_c-tb" onChange={this.onChange} value={this.password_c} type="text" label="Confirm Password" />
                    </div>
                    <div>
